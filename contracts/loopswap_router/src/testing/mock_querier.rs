...
use loopswap::asset::{Asset, AssetInfo, PairInfo};
use loopswap::pair::SimulationResponse;
...
pub struct WasmMockQuerier {
    ...
    loopswap_factory_querier: LoopswapFactoryQuerier,
}
...
#[derive(Clone, Default)]
pub struct LoopswapFactoryQuerier {
    pairs: HashMap<String, String>,
}

impl LoopswapFactoryQuerier {
    pub fn new(pairs: &[(&String, &String)]) -> Self {
        LoopswapFactoryQuerier {
            ...
            QueryRequest::Wasm(WasmQuery::Smart { contract_addr, msg }) => {
                match from_binary(&msg) {
                    Ok(QueryMsg::Pair { asset_infos }) => {
                        ...
                        match self.loopswap_factory_querier.pairs.get(&key) {
                            Some(v) => {
...
impl WasmMockQuerier {
    pub fn new(base: MockQuerier<TerraQueryWrapper>) -> Self {
        WasmMockQuerier {
            ...
            loopswap_factory_querier: LoopswapFactoryQuerier::default(),
        }
    }
    ...
    pub fn with_loopswap_pairs(&mut self, pairs: &[(&String, &String)]) {
        self.loopswap_factory_querier = LoopswapFactoryQuerier::new(pairs);
    }
}
