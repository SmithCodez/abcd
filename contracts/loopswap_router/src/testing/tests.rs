...
use loopswap::asset::{Asset, AssetInfo};
...
fn proper_initialization() {
    ...
    let msg = InstantiateMsg {
        loopswap_factory: "loopswapfactory".to_string(),
    };
    ...
    assert_eq!("loopswapfactory", config.loopswap_factory.as_str());
}
    ...
    assert_eq!(
        ...
        vec![
            ...
            SubMsg::new(CosmosMsg::Wasm(WasmMsg::Execute {
                ...
                funds: vec![],
                msg: to_binary(&ExecuteMsg::ExecuteSwapOperation {
                    operation: SwapOperation::LoopSwap {
                        offer_asset_info: AssetInfo::NativeToken {
                            denom: "ukrw".to_string(),
                        },
                        ask_asset_info: AssetInfo::Token {
...
fn execute_swap_operation() {
    ...
    deps.querier
        .with_loopswap_pairs(&[(&"uusdasset".to_string(), &"pair".to_string())]);
    ...
    deps.querier
        .with_loopswap_pairs(&[(&"assetuusd".to_string(), &"pair".to_string())]);
    deps.querier.with_token_balances(&[(
        &"asset".to_string(),
        &[(&MOCK_CONTRACT_ADDR.to_string(), &Uint128::from(1000000u128))],
    )]);
...
fn query_buy_with_routes() {
    ...
    deps.querier.with_loopswap_pairs(&[
