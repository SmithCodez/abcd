# Loopswap Router <!-- omit in toc -->

The Router Contract contains the logic to facilitate multi-hop swap operations via native & Loopswap.

**On-chain swap & Loopswap is supported.**
