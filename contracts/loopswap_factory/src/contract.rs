...
use cosmwasm_std::{
    to_binary, Addr, Binary, CanonicalAddr, Deps, DepsMut, Env, MessageInfo, Reply, ReplyOn, Response,
...
use loopswap::pair::InstantiateMsg as PairInstantiateMsg;
use loopswap::pair::ExecuteMsg as PairExecuteMsg;
...
pub fn execute(deps: DepsMut, env: Env, info: MessageInfo, msg: ExecuteMsg) -> StdResult<Response> {
    match msg {
        ExecuteMsg::UpdateConfig {
            ...
            pair_code_id,
            stake
        } => execute_update_config(deps, env, info, owner, token_code_id, pair_code_id, stake),
        ExecuteMsg::UpdatePairConfig {
            pair_addr,
            owner,
        } => execute_update_pair_config(deps, env, info, pair_addr, owner),
    ...
    Ok(Response::new()
        ...
        .add_submessage(SubMsg {
            ...
            msg: WasmMsg::Execute {
                ...
                msg: to_binary(&PairExecuteMsg::UpdateConfig {
                    owner: owner,
                    stake: config.stake,
                })?,
                funds: vec![],
